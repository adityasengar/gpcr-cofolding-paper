...
| 2,800 | R421 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 2,300 | R421 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 800 | R424 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 1,400 | R425 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 1,150 | R426 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 2,800 | R426 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 2,300 | R426 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
| 1,400 | S409 | Block C, verify_claims check C60.boltz |  2x2 cell row count, shipped n_rows against the census grid of 50 per receptor x backbone x role x arm |
