...
\textbf{[GAP: the threshold-band beat --- whether the shuffled-to-cognate gap
concentrates in the $\pm$0.5~\AA{} band around the tilt threshold --- is pending
an independent recomputation and will be inserted here.]}
...
above 0.98 in 28--29 of 40 cells per backbone, and a probability-scale
difference has little room left to move. All four backbones agree on the
logit-scale share to within four points (17.4, 17.5, 20.9, 17.5). Wherever this
term appears it is named with its scale \textbf{[FIG:decomposition]}.
