...
the 40 Class~A receptors (Fig.~2, Table~2).
...
different region, never used to set a threshold or to call anything (Fig.~3).
...
across 28 Class~A receptors (Fig.~4, Table~3). Three of four show no evidence of
...
correctness --- on two of four backbones (Fig.~5, Table~4).
