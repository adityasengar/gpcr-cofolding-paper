...
| G6d decoy, third role | E2.4 | 32 | — | — | 384 | 2,048 |
| G6f *(option)* same crossing at `R7_full` | E2.2 | 48 | 1,920 | 9,600 | — | — |
| G6fd *(option)* decoy at `R7_full` | E2.4 | 16 | — | — | 192 | 1,024 |
...
| **TOTAL** | | **350** | **8,320** | **37,760** | **1,376** | **7,072** |
